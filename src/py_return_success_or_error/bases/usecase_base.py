...
Classes:
    ...
    UsecaseBaseCallData: Classe base abstrata para casos de uso que requerem acesso a fontes de dados.
...
Tipos Genéricos:
    ...
    TypeParameters: Tipo genérico que representa os parâmetros de entrada, deve herdar de ParametersReturnResult.
...
Exemplo de definição de Parâmetros:
    >>>
        ...
        class InfoParametros(ParametersReturnResult):
            ...
            def __str__(self) -> str:
                return f'TestesParametrosGerais(informacoes={self.informacoes}, error={self.error})'
